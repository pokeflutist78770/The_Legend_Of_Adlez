...
public class Mountain extends GameMap {
	...
	public Mountain() {
		...
		transitions.add(new Transition(new Point2D(0, 8), MapScreen.RIVER, new Point2D(16, 8)));
		transitions.add(new Transition(new Point2D(0, 9), MapScreen.RIVER, new Point2D(16, 9)));
		transitions.add(new Transition(new Point2D(9, 1), MapScreen.DUNGEON1, new Point2D(9, 12)));
	}
