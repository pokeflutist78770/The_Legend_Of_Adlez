 ...
 *
 */
public class Dungeon2 extends GameMap {
	...
	/**
	 * Constructor for Dungeon2 map.
	 */
	public Dungeon2() {
		super(objects, transitions, enemies, MapScreen.DUNGEON2, "assets/bossRoom.png");
		...
		objects.add(new GameObject(new Point2D(2, 2)));              // the door
