...
public class Slime extends Enemy {
	 ...
	 * @param position Point The current position of the Slime.
	 */
	 ...
	 * @param position Point The current position of the Slime on the game map.
	 * @param n int The type of movement pattern that the Slime will have.
	 */
	public Slime(Point position, int n) {
		super(position, n);
		this.setTotalHP(10);
		this.setAttack(1);
